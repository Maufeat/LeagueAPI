...
namespace lol {
  inline Result<std::vector<LolLobbyLobbyInvitationDto>> PostLolLobbyV2LobbyInvitations(LeagueClient& _client, const std::vector<LolLobbyLobbyInvitationDto>& invitations)
  {
    try {
      return Result<std::vector<LolLobbyLobbyInvitationDto>> {
        _client.https.request("post", "/lol-lobby/v2/lobby/invitations?" +
  ...
  inline void PostLolLobbyV2LobbyInvitations(LeagueClient& _client, const std::vector<LolLobbyLobbyInvitationDto>& invitations, std::function<void(LeagueClient&,const Result<std::vector<LolLobbyLobbyInvitationDto>>&)> cb)
  {
