  ...
  Result<std::vector<LolSuggestedPlayersSuggestedPlayersSuggestedPlayer>> GetLolSuggestedPlayersV1SuggestedPlayers(const LeagueClient& _client)
  {
    ...
    try {
      return Result<std::vector<LolSuggestedPlayersSuggestedPlayersSuggestedPlayer>> {
        _client_.request("get", "/lol-suggested-players/v1/suggested-players?" +
      ...
      return Result<std::vector<LolSuggestedPlayersSuggestedPlayersSuggestedPlayer>> { Error { to_string(e.code().value()), -1, e.what() } };
    }
  }
}