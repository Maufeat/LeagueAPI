...
namespace lol {
  inline Result<std::string> PutLolCollectionsV1InventoriesBySummonerIdVerification(const LeagueClient& _client, const uint64_t& summonerId, const std::string& verificationCode)
  {
