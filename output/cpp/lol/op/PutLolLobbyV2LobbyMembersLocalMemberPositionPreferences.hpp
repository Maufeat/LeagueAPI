...
namespace lol {
  Result<json> PutLolLobbyV2LobbyMembersLocalMemberPositionPreferences(const LeagueClient& _client, const LolLobbyLobbyPositionPreferences& positionPreferences)
  {
    ...
    return _client_.request("put", "/lol-lobby/v2/lobby/members/localMember/position-preferences?" + SimpleWeb::QueryString::create(Args2Headers({  })), json(positionPreferences).dump(),
