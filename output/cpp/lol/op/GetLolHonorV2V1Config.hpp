  ...
  inline Result<LolHonorV2HonorConfig> GetLolHonorV2V1Config(LeagueClient& _client)
  {
    try {
      return Result<LolHonorV2HonorConfig> {
        _client.https.request("get", "/lol-honor-v2/v1/config?" +
      ...
      return Result<LolHonorV2HonorConfig> { Error { to_string(e.code().value()), -1, e.code().message() } };
    }
  }
    ...
    _client.httpsa.request("get", "/lol-honor-v2/v1/config?" +
      SimpleWeb::QueryString::create(Args2Headers({  })), 
        ...
        {"Authorization", _client.auth},  }),[cb,&_client](std::shared_ptr<HttpsClient::Response> response, const SimpleWeb::error_code &e) {
          if(!e)
            cb(_client, Result<LolHonorV2HonorConfig> { response });
          else
            cb(_client,Result<LolHonorV2HonorConfig> { Error { to_string(e.value()), -1, e.message() } });
        });
  }
}