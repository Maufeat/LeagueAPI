...
namespace lol {
  ...
  inline void to_json(json& j, const LolChampSelectLegacyChampSelectTradeState& v) {
  ...
  inline void from_json(const json& j, LolChampSelectLegacyChampSelectTradeState& v) {
