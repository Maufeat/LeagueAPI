...
namespace lol {
  ...
  inline void to_json(json& j, const LolMatchmakingMatchmakingReadyCheckResponse& v) {
  ...
  inline void from_json(const json& j, LolMatchmakingMatchmakingReadyCheckResponse& v) {
