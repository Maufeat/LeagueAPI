...
namespace lol {
  ...
  inline void to_json(json& j, const LolChampSelectLegacyChampSelectMySelection& v) {
    if(v.wardSkinId)
  ...
  inline void from_json(const json& j, LolChampSelectLegacyChampSelectMySelection& v) {
