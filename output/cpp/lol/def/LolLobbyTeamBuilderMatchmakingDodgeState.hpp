...
namespace lol {
  ...
  inline void to_json(json& j, const LolLobbyTeamBuilderMatchmakingDodgeState& v) {
  ...
  inline void from_json(const json& j, LolLobbyTeamBuilderMatchmakingDodgeState& v) {
