...
namespace lol {
  ...
  inline void to_json(json& j, const LolPlayerBehaviorPlayerNotificationResource& v) {
  ...
  inline void from_json(const json& j, LolPlayerBehaviorPlayerNotificationResource& v) {
