...
namespace lol {
  ...
  inline void to_json(json& j, const LolLobbyTeamBuilderMatchmakingSearchErrorResource& v) {
    j["message"] = v.message; 
    j["id"] = v.id; 
  ...
  inline void from_json(const json& j, LolLobbyTeamBuilderMatchmakingSearchErrorResource& v) {
