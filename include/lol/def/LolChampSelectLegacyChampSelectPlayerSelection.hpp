...
namespace lol {
  ...
  inline void to_json(json& j, const LolChampSelectLegacyChampSelectPlayerSelection& v) {
    j["cellId"] = v.cellId; 
  ...
  inline void from_json(const json& j, LolChampSelectLegacyChampSelectPlayerSelection& v) {
