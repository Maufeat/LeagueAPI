...
namespace lol {
  struct LolChatFriendCountsResource { 
    uint32_t numFriends;
  ...
  inline void to_json(json& j, const LolChatFriendCountsResource& v) {
  ...
  inline void from_json(const json& j, LolChatFriendCountsResource& v) {
