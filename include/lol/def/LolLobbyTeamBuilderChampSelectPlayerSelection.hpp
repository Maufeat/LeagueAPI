...
namespace lol {
  ...
  inline void to_json(json& j, const LolLobbyTeamBuilderChampSelectPlayerSelection& v) {
  ...
  inline void from_json(const json& j, LolLobbyTeamBuilderChampSelectPlayerSelection& v) {
