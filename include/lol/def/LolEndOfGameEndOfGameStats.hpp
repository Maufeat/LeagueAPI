...
namespace lol {
  struct LolEndOfGameEndOfGameStats { 
    ...
    uint64_t preLevelUpExperienceTotal;
    uint64_t preLevelUpNextLevelXp;
  ...
  inline void to_json(json& j, const LolEndOfGameEndOfGameStats& v) {
    ...
    j["preLevelUpExperienceTotal"] = v.preLevelUpExperienceTotal; 
    j["preLevelUpNextLevelXp"] = v.preLevelUpNextLevelXp; 
  ...
  inline void from_json(const json& j, LolEndOfGameEndOfGameStats& v) {
    ...
    v.preLevelUpExperienceTotal = j.at("preLevelUpExperienceTotal").get<uint64_t>(); 
    v.preLevelUpNextLevelXp = j.at("preLevelUpNextLevelXp").get<uint64_t>(); 
