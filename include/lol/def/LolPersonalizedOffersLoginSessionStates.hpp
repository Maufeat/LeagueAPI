...
namespace lol {
  ...
  inline void to_json(json& j, const LolPersonalizedOffersLoginSessionStates& v) {
  ...
  inline void from_json(const json& j, LolPersonalizedOffersLoginSessionStates& v) {
