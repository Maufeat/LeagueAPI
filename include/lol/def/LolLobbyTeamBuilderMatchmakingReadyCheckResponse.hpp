...
namespace lol {
  ...
  inline void to_json(json& j, const LolLobbyTeamBuilderMatchmakingReadyCheckResponse& v) {
  ...
  inline void from_json(const json& j, LolLobbyTeamBuilderMatchmakingReadyCheckResponse& v) {
